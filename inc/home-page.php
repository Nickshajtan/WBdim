           ...
           <div class="slider_item design_slide">
             ...
             <div class="slider_topic_section design_slide_topic justify-content-center align-items-center d-flex">
                <div class="container justify-content-center align-items-center d-flex">
                    ...
                    <div class="justify-content-center align-items-center d-flex"><span class="justify-content-center align-items-center d-flex">
                        <a href="<?php echo get_bloginfo(); ?>/contacts"><?php echo __('Замовити дизайн'); ?></a><span></span></span></div>
